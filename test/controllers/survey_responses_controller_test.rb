...
class SurveyResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survey_response" do
    assert_difference("SurveyResponse.count") do
      post survey_responses_url, params: { survey_response: { survey_id: @survey_response.survey_id, user_id: @survey_response.user_id } }
    end
  ...
  test "should update survey_response" do
    patch survey_response_url(@survey_response), params: { survey_response: { survey_id: @survey_response.survey_id, user_id: @survey_response.user_id } }
