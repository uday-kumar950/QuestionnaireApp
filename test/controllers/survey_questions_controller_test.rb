...
class SurveyQuestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survey_question" do
    assert_difference("SurveyQuestion.count") do
      post survey_questions_url, params: { survey_question: { question_id: @survey_question.question_id, survey_id: @survey_question.survey_id } }
    end
  ...
  test "should update survey_question" do
    patch survey_question_url(@survey_question), params: { survey_question: { question_id: @survey_question.question_id, survey_id: @survey_question.survey_id } }
